...
Une fois exécuté, le programme affiche de manière destructure 5 lettres:
- S
- L
- A
- S
...
En utilisant ce mot de passe pour se connecter, on peut constater que le jeu de mot de passe
est incorrecte.
...
Grace a un buffer overflow, il est egalement possible de passer un shellcode, qui
